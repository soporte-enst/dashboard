...
import{a as e,b as o,i,k as l,l as r,o as a,s as n,v as p}from"./chunk-FNWZ2XAN.mjs";var s=`<!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * -->\r
<!-- * * * * * * * * * * * The content below * * * * * * * * * * * -->\r
...
\r
<router-outlet />\r
`;var c="";var t=class{constructor(){this.title="dashboardPosgrados"}};t=e([o({selector:"app-root",standalone:!0,imports:[n],template:s,styles:[c]})],t);var h=[];var g={providers:[p(h),r()]};var f={providers:[a()]},v=i(g,f);var u=()=>l(t,v),B=u;export{B as a};
